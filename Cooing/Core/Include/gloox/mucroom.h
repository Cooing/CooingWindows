...
namespace gloox
{
                            ...
                            public IqHandler, private MessageHandler, private DiscoNodeHandler
  {
    public:
      ...
      class MUC : public StanzaExtension
      {
        public:
          ...
          MUC( const std::string& password, HistoryRequestType historyType = HistoryUnknown,
               const std::string& historySince = "", int historyValue = 0 );
       ...
       */
      void invite( const JID& invitee, const std::string& reason, const std::string& thread = "" );
      ...
      void destroy( const std::string& reason = "",
                    const JID& alternate = JID(), const std::string& password = "" );
    ...
    public:
      ...
      class MUCOwner : public StanzaExtension
      {
        public:
           ...
           */
          MUCOwner( const JID& alternate = JID(), const std::string& reason = "",
