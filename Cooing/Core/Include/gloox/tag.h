...
//       const std::string addXmlns( const std::string& xmlns, bool def );
       ...
       * @since 1.0
       */
      bool setXmlns( const std::string& xmlns, const std::string& prefix = "" );
       ...
       */
      bool hasChild( const std::string& name, const std::string& attr = "",
                     const std::string& value = "" ) const;
       ...
       * @since 0.9
       */
      TagList findChildren( const std::string& name, const std::string& xmlns = "" ) const;
       ...
       * @param xmlns An optional namespace to check for.
       */
      void removeChild( const std::string& name, const std::string& xmlns = "" );
       ...
       * @param xmlns An optional namespace to check for.
       */
      void removeAttribute( const std::string& attr, const std::string& value = "",
                            const std::string& xmlns = "" );
